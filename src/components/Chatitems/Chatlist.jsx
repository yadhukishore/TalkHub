...
import { MessageCircleIcon, MoreVertical, Trash, Search, Star } from "lucide-react";
...
function ChatList({ setActiveChat }) {
  ...
  // Function to randomly assign a "verified" status to some chats
  const isVerified = (refid) => {
    // Use a deterministic way to get some chats marked as premium
  ...
  return (
    <div className="flex flex-col h-full bg-zinc-900 border-r border-zinc-800">
      <Card className="rounded-none border-none shadow-none flex flex-col h-full bg-zinc-900">
        <CardHeader className="border-b border-zinc-800 shrink-0 px-4 py-3">
          <div className="flex flex-col space-y-3">
            <CardTitle className="flex items-center text-white">
              <MessageCircleIcon className="mr-2 h-5 w-5 text-yellow-400" />
              My Chats
            </CardTitle>
          ...
          <ScrollArea className="h-full">
            {isLoading ? (
                          ...
                          <div className="relative">
                            {chat.profilePic ? (
                              ...
                              <div className="w-10 h-10 rounded-full bg-zinc-700 flex items-center justify-center border-2 border-zinc-600">
                                <MessageCircleIcon className="h-5 w-5 text-zinc-300" />
                              </div>
                            )}
              ...
              <div className="p-8 text-center text-zinc-500 flex flex-col items-center">
                <MessageCircleIcon className="h-12 w-12 mb-3 text-zinc-700" />
                {searchQuery ? 
