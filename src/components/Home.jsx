    ...
    <div className="h-full flex flex-col bg-black">
      <div className="flex-1 overflow-hidden">
        <ResizablePanelGroup direction="horizontal" className="h-full">
          ...
          {/* User Info Panel */}
          <ResizablePanel defaultSize={25} minSize={20} className="bg-[#121212] text-white p-4 flex flex-col items-center">
            <div className="flex flex-col items-center mt-4">
              <div className="w-24 h-24 rounded-full bg-gray-700 flex items-center justify-center">
                <UserIcon className="w-12 h-12 text-yellow-400" />
              </div>
              <h3 className="text-xl font-bold mt-3">{selectedUsername || "User Name"}</h3>
              <p className="text-gray-400 text-sm flex items-center">
                <MailIcon className="w-4 h-4 mr-2" /> user@example.com
              </p>
              <p className="text-green-400 mt-1 flex items-center">
                <ShieldCheckIcon className="w-4 h-4 mr-2" /> Online
              </p>
            </div>
            <div className="mt-6 space-y-3 w-full">
              <Button className="w-full bg-yellow-400 hover:bg-yellow-500 text-black font-medium">Edit Profile</Button>
              <Button className="w-full bg-red-600 hover:bg-red-700 text-white font-medium flex items-center justify-center">
